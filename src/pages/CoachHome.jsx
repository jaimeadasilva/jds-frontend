...
export default function CoachHome() {
  ...
  // Stats: active clients + two useful numbers
  const thisWeekClients = clients.length; // could filter by last_login in future
      ...
      <div style={{
        ...
        <div style={{ position:"relative", zIndex:1 }}>
          <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start" }}>
            <div>
              <p style={{ color:"rgba(255,255,255,0.6)", fontSize:13, fontWeight:500, margin:"0 0 4px", letterSpacing:"0.01em" }}>{greeting()},</p>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:10, marginTop:22 }}>
            {[
              ...
              { label:"This Week",     value: thisWeekClients,        icon:"🗓" },
            ].map(s => (
          ...
          <div className="stagger" style={{ display:"flex", flexDirection:"column", gap:10, marginBottom:28 }}>
            ...
            {clients.length === 0 && (
              <div style={{ textAlign:"center", padding:"32px 0", color:"var(--muted)" }}>
                ...
                <p style={{ fontWeight:600 }}>No clients yet. Add your first one!</p>
              </div>
            )}
          </div>
        )}
